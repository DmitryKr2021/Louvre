class DatePicker {
  constructor(elem) {
    ...
    /************моя вставка***********/
    this.calernder.style.zIndex = '20';
    /**********************************/
    ...
    let myDayNumber;
    let myDayWeek;
    const tRD = document.querySelector('.ticket-resume__date');
    ...
    this.daysDiv.addEventListener('click', e => {
      ...
      if (day) {
        ...
        /*******************************/
        myMonth = this.month; //моя вставка
        /*******************************/
        this.markedYear = this.year;
        let d = String(day);
        /******************************/
        myDayNumber = d; //моя вставка
        /******************************/
      ...
      tRD.textContent = allMonths[+myMonth] + ' ' + myDayNumber;
    });
